(function () {
    ...
    return {
      ...
      "evac-0": {
        html:
          ...
          fs("3", "Подготовка", "сортировочная готовность: приём, осмотр, регистрация") +
          "</div>" +
      ...
      "evac-sort": {
        ...
        html:
          ...
          fs("1", "Осмотр", "распределение по виду поражения и состоянию") +
          fs("2", "Решение", "назначение дальнейшей помощи и эвакуации") +
          fs("3", "Отметки", "цветные маркеры на одежде") +
          fs("4", "Фиксация", "данные в медкарточке передового района") +
          "</div>" +
      ...
      "evac-1": {
        ...
        html:
          ...
          fs("B", "Стабилизация", "иммобилизация переломов") +
          fs("C", "Документы", "регистрация и медкарточка передового района") +
          "</div>" +
      ...
      "evac-2": {
        ...
        html:
          sg([
            { v: "50–60%", l: "всех нуждавшихся в хирургии оперировали в МСБ" },
          ...
          "</div>" +
          "<p class=\"modal-text\">МСБ — ключевой хирургический узел. Здесь квалифицированная помощь приближалась к линии боя и снижала тяжесть последствий до этапа госпиталя.</p>",
      },
      "evac-3": {
        wide: true,
        html:
          sg([
            { v: "2,5–3,5%", l: "контуженые в структуре боевых потерь" },
            { v: "62%", l: "выписка контуженых после лечения" },
            { v: "спецпрофиль", l: "невропсихиатрические и профильные отделения" },
            { v: "по назначению", l: "маршрутизация после сортировки" },
          ]) +
          '<div class="modal-viz" style="margin-top:1rem">' +
          fs("1", "Профилизация", "распределение по характеру поражения") +
          fs("2", "Лечение", "специализированная помощь в госпиталях") +
          fs("3", "Исход", "возврат в часть / дальнейшая эвакуация") +
          "</div>" +
          "<p class=\"modal-text\">Госпитальный этап завершал сортировку «по назначению»: лечили на месте максимально возможно, чтобы сократить лишнюю эвакуацию за пределы фронта.</p>",
      },
      "evac-4": {
        wide: true,
        html:
          sg([
            { v: "Ж/д", l: "военно-санитарные поезда и летучки" },
            { v: "Вода", l: "лодки, баржи, пароходы (щадящая эвакуация)" },
            { v: "Воздух", l: "самолёты для быстрой переброски" },
            { v: "Шоссе/гуж", l: "ГАЗ, ЗИС, лошади, собаки, олени" },
          ]) +
          '<div class="modal-viz" style="margin-top:1rem">' +
      ...
      "pmp-dressing": {
        ...
        html:
          ...
          '<div class="modal-chart" style="margin-top:1rem">' +
          br("Вагосимпатические блокады (2,4%)", 2.4) +
          br("Футлярные анестезии (4,4%)", 4.4) +
          "</div>" +
      ...
      "pmp-osadok": {
        html:
          sg([
            { v: "Осадочник", l: "сбор/очистка стоков" },
      ...
      "pmp-bunkers": {
        html:
          sg([
            { v: "Блиндажи", l: "укрытия персонала" },
  ...
  const MODAL_TITLES = {
    ...
    "evac-2": "Медсанбат (МСБ)",
    "evac-3": "Армейский госпиталь",
    "evac-4": "Эвакуация в тыл",
